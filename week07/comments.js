// A the code that is responsible to get and set info for a part of the application is often called a model. I've used that terminology here.
...
class CommentTemplate {
  ...
  // Comments: this code handles getting the list of comments from the info source, and outputting them to the screen at the right time.  This is often catagorized as Controller code.
  
  class Comments {
    constructor(type, commentElementId) {
      this.type = type;
      this.commentElementId = commentElementId;
      this.model = new CommentTemplate(this.type);
    }
    ...
    addSubmitListener(hikeName) {
      ...
      document.getElementById('submitComment').ontouchend = () => {
        // debugger;
        this.model.createComment(
          hikeName,
    ...
    showCommentList(q = null) {
      try {
        ...
        // check to see if the commentForm code has been added yet
        if (parent.innerHTML === '') {
        ...
        if (q !== null) {
          ...
          document.querySelector('.createComment').style.display = 'none';
        }
